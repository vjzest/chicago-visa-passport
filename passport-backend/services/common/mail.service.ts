        ...
        <tr>
            <td style="padding: 20px;">
                <table width="100%">
                    <tr>
                        <td>
                            <h2 style="font-size: 24px; font-weight: 300; color: #4a5568; margin: 0;">JET <span style="color: #ed8936;">PASSPORTS</span></h2>
                        </td>
                ...
                <table width="100%" style="margin-top: 20px;">
                    <tr>
                        <td style="text-align: center;">
                            ...
                            <p style="font-size: 12px; color: #718096; margin: 0;">Thank you, Jet Passports Service</p>
                        </td>
                    </tr>
                </table>
            </td>
...
<html>
  ...
  <body style="font-family: Arial, sans-serif; background-color: #f0f0f0; margin: 0; padding: 20px;">
    <table cellpadding="0" cellspacing="0" border="0" width="100%" style="max-width: 600px; margin: 0 auto; background-color: white; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); border: 1px solid #e5e5e5; border-radius: 8px;">
                ...
                <tr>
                  <td>
                    <h2 style="font-size: 24px; font-weight: 300; color: #4a5568; margin: 0;">
                      JET <span style="color: #ed8936;">PASSPORTS</span>
                    </h2>
                  </td>
                </tr>
              </tbody>
              ...
              <tbody>
                <tr>
                  <td style="text-align: center;">
                    ...
                    <p style="font-size: 12px; color: #718096; margin: 0;">
                      Thank you, Jet Passports Service
                    </p>
                  </td>
                </tr>
              </tbody>
      ...
      const data = {
        sender: { name: "Jet Passports", email: ENV.FROM_EMAIL },
