...
class NmiPaymentService {
  ...
  > {
    ...
    try {
      ...
      let totalAmount = serviceLevelTotal + additionalServicesTotal;
      console.log({ totalAmount, serviceLevelTotal, additionalServicesTotal });
      let discount = 0;
      let promoCode = "";
      if (appliedPromo) {
  ...
  > {
    ...
    console.log("selected gateway: ", processorCreds.userName);
