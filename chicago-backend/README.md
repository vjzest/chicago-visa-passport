## Chicago Passport & Visa Expedite Server

This project is a Node.js application for handling the server of Chicago Passport & Visa Expedite, written in TypeScript using MongoDB as primary DB and redis for cache.
