    ...
    try {
      ...
      if (contingentCase) {
        ...
        <div style="font-family: Arial, sans-serif; color: #333; line-height: 1.6;">
          <h2 style="color: #5cb85c;">Complete Your Visa Application</h2>
          <p>Dear ${fullName},</p>
          <p>We noticed that you have an incomplete Visa application in our system.</p>
        ...
        const data = {
          ...
          fullName: fullName,
          subject: "Chicago Passport & Visa Expedite Services: Complete Your Visa Application",
