...
export const metadata: Metadata = {
  title: "Terms and Conditions - Chicago Passport & Visa Expedite",
      ...
      <div className="relative h-[50vh] overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 text-center">
          ...
          <Link
            ...
            className="ml-14 rounded-xl w-fit bg-[#006DCC] hover:bg-[#144066] text-white px-8 py-4 transition-colors duration-300 flex items-center gap-2 group text-sm md:text-base"
          >
            Start Application
