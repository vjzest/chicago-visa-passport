...
export default function Page({
  ...
  return caseDetails ? (
    <div className="flex flex-col w-full items-center justify-center bg-[#F2F2F7">
      ...
      <div className="w-10/12 lg:w-8/12 mt-16 rounded-lg overflow-hidden shadow-lg">
        <OrderConfirmationV2
      ...
      {/* Next steps */}
      <div className="flex flex-col items-center justify-center mt-10 w-full md:w-[85%]">
