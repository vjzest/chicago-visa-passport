...
export default function PassportOrderConfirmationPage({
        ...
        <div className="flex flex-col w-full items-center justify-center bg-[#F2F2F7]">
            ...
            <div className="flex flex-col items-center  p-3 sm:p-5 justify-center mt-10 w-full md:w-[85%]">
                ...
                <p className="text-base md:text-lg text-primary font-semibold mb-6 text-center max-w-2xl">
                    {isLoggedIn
                        ? "Please continue to your Passport Client Portal and complete the steps below"
                        : "Please login to the Passport Client Portal to complete the steps below"}
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2  gap-6 w-full">
                    ...
                    <Card className="flex items-start gap-4 p-6 shadow-lg">
                        <div className="flex-1">
                            <h3 className="font-semibold text-lg mb-2">Passport Client Portal</h3>
                            <p className="text-sm text-gray-700">
                                Access the Passport Client Portal. Then go to &apos;My applications&apos;
                                and click on &apos;Get started&apos;. Fill all the necessary
                                questions provided to you.
                            </p>
                            <Link
                                href={accessToken ? "/us-passport/dashboard" : "/us-passport/login"}
                            >
