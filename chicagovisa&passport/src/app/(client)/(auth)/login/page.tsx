"use client";
import LoginForm from "@/components/pages/login/login-component";
import { FC } from "react";

const Login: FC = () => {
  return (
    <div className="flex w-full justify-center">
      <div className="my-3 flex w-11/12 flex-col items-center gap-y-4 rounded-md  px-3 py-5 shadow-full md:w-2/5 md:flex-row md:justify-center md:px-0">
        {/* {forgot ? (
          <ForgotPasswordForm setForgot={setForgot} />
        ) : ( */}
        <LoginForm />
        {/* )} */}
        {/* <div className="flex h-full w-[90%] items-center justify-center md:w-1/4">
          <ReferralCard />
        </div> */}
