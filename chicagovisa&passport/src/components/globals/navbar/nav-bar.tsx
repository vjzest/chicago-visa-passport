...
const Navbar = () => {
  ...
  const navLinks = [
    { href: "/", label: "Home" },
    {
      ...
      subLinks: [
        { href: "/new-adult-passport", label: "New Passport" },
        { href: "/passport-renewal", label: "Passport Renewal" },
        { href: "/child-passport-services", label: "Child Passport" },
        { href: "/passport-name-change", label: "Name Change" },
        { href: "/lost-stolen-passport", label: "Lost Passport" },
        { href: "/damaged-passport", label: "Damaged Passport" },
        { href: "/passport-card", label: "Passport Card" },
      ],
    },
