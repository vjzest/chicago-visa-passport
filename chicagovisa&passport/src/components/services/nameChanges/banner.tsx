  ...
  return (
    <div className="relative w-full bg-[#F2F9FF] min-h-[400px] sm:min-h-[700px] lg:min-h-[600px] overflow-hidden">
      ...
      <div className="container mx-auto px-4 h-full flex flex-col items-center [@media(min-width:1290px)]:block">
        {/* Left Content */}
        <div className="relative pt-8 sm:pt-12 [@media(min-width:1290px)]:absolute [@media(min-width:1290px)]:top-24 [@media(min-width:1290px)]:left-14 w-full [@media(min-width:1290px)]:max-w-[45%] flex flex-col items-center [@media(min-width:1290px)]:items-start">
