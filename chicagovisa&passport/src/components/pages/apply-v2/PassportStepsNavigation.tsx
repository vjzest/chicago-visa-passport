...
const PassportStepsNavigation: React.FC<StepsNavigationProps> = ({
    currentStep,
    setCurrentStep,
    forms,
    setTriggerSubmit,
    ...
    const steps = [
        {
            ...
            number: 1,
            title: "Passport type, Applicant and Contact information",
        ...
        <div className="bg-white p-6  border border-gray-200 lg:h-screen sticky top-6">
            ...
            <div className="text-center mb-6">
                <h2 className="text-sm font-semibold  uppercase tracking-wide mb-1 text-primary  ">
                    Follow these 3 simple steps to Start processing your Passport
                </h2>
            </div>
...
export default PassportStepsNavigation;
