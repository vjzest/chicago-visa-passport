...
const DedicatedPassportTypeSelection: React.FC<{ serviceTypes: any[] }> = ({
    serviceTypes,
}) => {
    ...
    return (
        <div className="space-y-6" id="serviceTypeSelectCard">
            ...
            {generalFormData?.serviceType && (
                <div className="bg-primary/5 border border-primary rounded-lg p-4">
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            <h4 className="font-medium text-primary mb-1">PASSPORT TYPE</h4>
                            <div
            ...
            <div>
                ...
                {!hasCountrySelections && passportTypes.length === 0 && (
                    <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 text-center">
                        ...
                        <p className="text-gray-600 mb-4">
                            ...
                            from the homepage to view available passport types.
                        </p>
                        <button
                            onClick={() => router.push("/")}
                ...
                {/* Show message if countries selected but no matching passport types */}
                {hasCountrySelections && passportTypes.length === 0 && (
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 text-center">
                        ...
                        <h4 className="font-semibold text-gray-900 mb-2">
                            No Passport Types Available
                        </h4>
                        <p className="text-gray-600 mb-4">
                            {`Unfortunately, we don't currently offer passport services for your
              ...
              contact us for assistance.`}
                ...
                {/* Show passport types if available */}
...
export default DedicatedPassportTypeSelection;
