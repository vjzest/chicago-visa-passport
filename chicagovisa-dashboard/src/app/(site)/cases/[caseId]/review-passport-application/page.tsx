...
import PassportFormPreview from "@/components/pages/cases/passport-form/details-preview";
import PPTFormUpload from "@/components/pages/cases/passport-form/upload-ppt-form";
