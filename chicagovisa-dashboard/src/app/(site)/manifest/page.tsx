...
import ManifestTable from "@/components/pages/manifest/manifest-table";
import * as ExcelJS from "exceljs";
import { saveAs } from "file-saver";
import { removeHtmlTags } from "@/lib/utils";
import { CustomDateInput } from "@/components/globals/custom-date-input";
    ...
    try {
      ...
      allRecords.forEach((record: ManifestRecord) => {
        ...
        worksheet.addRow([
          ...
          managerName,
          record.paymentMethod || (record.isOfflineLink || record.deviceInfo?.isOfflineLink ? "Offline" : "Online"),
          cleanRemarks,
        ]);
      });
