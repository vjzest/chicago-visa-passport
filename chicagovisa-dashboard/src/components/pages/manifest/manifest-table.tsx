  ...
  const columns: ColumnDef<ManifestRecord>[] = [
    {
      ...
      cell: ({ row }) =>
        access?.viewManifest?.viewDetail ? (
          <Link
    ...
    },
    {
      ...
      header: (props) => (
        <Cell value={<SortableHeader {...props} title="Payment Method" />} />
      ),
      cell: ({ row }) => (
        <Cell value={row.original.paymentMethod || "Online"} />
      ),
    },
    {
